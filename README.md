...
Flame Graph: 
![Flame Graph](../React/rs-react-app/src/assets/to/flame.png)
Ranked Char: 
![Ranked Char](../React/rs-react-app/src/assets/to/ranked.png)
...
Interactions: using sort low <br>
Flame Graph: 
![Flame Graph](../React/rs-react-app/src/assets/after_flame.png)
Ranked Char: 
![Ranked Char](../React/rs-react-app/src/assets/after_ranked.png)